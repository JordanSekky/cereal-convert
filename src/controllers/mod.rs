...
use crate::{
    rate_limit::ip_rate_limit_filter, rate_limit::path_method_limit_filter,
    util::InstrumentedPgConnectionPool,
};
...
pub fn get_server_future(pool: &InstrumentedPgConnectionPool) -> impl Future<Output = ()> {
